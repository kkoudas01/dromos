...
@media(max-width:700px){
  ...
  #sidebar{position:fixed;left:0;top:56px;bottom:0;z-index:200;transform:translateX(-110%);overflow-y:auto}
  #sidebar.open{transform:translateX(0)}
  #search-input{width:140px}
}
@media(max-width:700px) and (orientation:landscape){
  html,body{height:auto;overflow:auto}
  #layout{min-height:calc(100vh - 56px);overflow:visible}
  #main{overflow:visible;height:auto}
  #sidebar{position:fixed;top:56px;bottom:0;overflow-y:auto}
}
</style>'''
